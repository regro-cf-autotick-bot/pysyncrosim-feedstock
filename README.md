...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pysyncrosim-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15055&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pysyncrosim-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pysyncrosim` can be installed with:

```
conda install pysyncrosim
```

It is possible to list all of the versions of `pysyncrosim` available on your platform with:
